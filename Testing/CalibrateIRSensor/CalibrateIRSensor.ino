...
void loop()
{
  ...
  if (leftObstacleSensor() == true ){      // Both sensors detect white surface so just run and run!
    Serial.println("LEFT");  
  
  }
   if (rightObstacleSensor() == true ){      // Both sensors detect white surface so just run and run!
